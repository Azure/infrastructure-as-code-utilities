...
Write-Ouput "- IMPORTANT! It is possible that updating PowerShell may cause this script to terminate early. If this happens, please close the terminal window, open a new admin terminal and run the script again..."
